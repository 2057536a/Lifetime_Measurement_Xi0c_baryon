...
hist1 = ROOT.TH1F('hist1','hist1', 9, 0.0001, 0.001)
...
while Xc_TAU_lower_limit < Xc_TAU_upper_limit:
    ...
    hist1.SetBinContent(bin_index,signal_number)
    hist1.SetBinError(bin_index,error_signal)
...
myhistogram = ROOT.TFile('myhist.root','recreate')        #creates a new myhist.root file
hist1.Write()                                             # writes the histogram into the root file so it can be retrieved later for RooDataHist
