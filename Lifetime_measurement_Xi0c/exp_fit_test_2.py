...
datafile1 = ROOT.TFile("myhist.root")           # retrieve the root file where the histogram is saved
hist1 = datafile1.Get("hist1") 
...
binnedData = ROOT.RooDataHist("binnedData", "binnedData", ROOT.RooArgList(xc_tau),ROOT.RooFit.Import(hist1))        # RooDataHist making
