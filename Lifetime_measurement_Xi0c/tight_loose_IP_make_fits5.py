...
datafile1 = ROOT.TFile("myhist7.root")           # retrieve the root file where the histogram is saved
hist7 = datafile1.Get("hist7") 
...
binnedData = ROOT.RooDataHist("binnedData", "binnedData", ROOT.RooArgList(xc_tau),ROOT.RooFit.Import(hist7))        # RooDataHist making
